-- Preserve the published version's complete stage contract when opening a
-- draft. The older implementation cloned legacy workflow_stages, which lost
-- canonical owners and versioned settings even though the source version was
...
begin
  ...
  if exists (
    ...
    select
      ...
      s.responsible_org_id,
      s.responsible_org_code,
