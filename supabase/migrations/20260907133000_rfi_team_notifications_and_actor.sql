-- Make RFI response ownership and team notifications database-owned.
-- Notifications are emitted only for configured active assignment-group
-- members; free-text names and guessed recipients are never used.
