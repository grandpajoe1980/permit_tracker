-- Idempotent replay of the null-safe ticket authorization function.
-- The first application was recorded as 20260907123737 while this checkout
-- was being synchronized; keeping this replay in source preserves the live
-- migration ledger without changing behavior.
