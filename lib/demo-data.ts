...
export const demoPersonas: DemoPersona[] = [
  {
    ...
    email: "alex.martin@spacex.com",
    legacyEmails: ["alex.martin@spacex.test"],
  ...
  },
  {
    ...
    group: "SpaceX Louisiana Program",
    displayTitle: "Intergovernmental Affairs Coordinator",
    organization: "Vermilion Parish Police Jury",
    organizationalUnit: "Parish Administration · Community Relations",
    workEmail: "riley.brooks@vermilionparish.org",
  },
  {
    id: "joe-skaggs",
    name: "Joe Skaggs",
    role: "PATH Administrator",
    roleDescription: "Louisiana Economic Development administrator for PATH project delivery",
    email: "joe.skaggs@la.gov",
    password: "PATH-MVP-2026!",
    badge: "Administrator",
    scenario: "Participant, workflow, and escalation administration",
    group: "SpaceX Louisiana Program",
    displayTitle: "Space Czar",
    organization: "Louisiana Economic Development (LED)",
    organizationalUnit: "PATH / Louisiana Project Delivery Administration",
  ...
  },
  {
    id: "elon-musk",
    name: "Elon Musk",
    role: "SpaceX Executive Sponsor",
    roleDescription: "Executive project sponsor reviewing the customer-facing delivery view",
    email: "elon.musk@spacex.demo",
    badge: "Executive",
    scenario: "Executive customer oversight",
    group: "SpaceX Louisiana Program",
    displayTitle: "SpaceX Executive Sponsor",
    organization: "Space Exploration Technologies Corp. (SpaceX)",
    organizationalUnit: "Executive Office",
    workEmail: "elon.musk@spacex.demo",
  },
  {
    id: "jeff-landry",
    name: "Jeff Landry",
    role: "Governor / Executive Sponsor",
    roleDescription: "State executive sponsor reviewing cross-agency delivery and escalation work",
    email: "jeff.landry@la.gov.demo",
    badge: "Executive",
    scenario: "State executive oversight",
    group: "Louisiana Governor's Office of Major Projects & Delivery",
    displayTitle: "Governor of Louisiana",
    organization: "Office of the Governor",
    organizationalUnit: "Executive Office",
    workEmail: "jeff.landry@la.gov.demo",
  },
  {
    id: "susan-bourgeois",
    name: "Susan Bourgeois",
    role: "LED Secretary / Executive Sponsor",
    roleDescription: "Economic development executive sponsor coordinating state delivery support",
    email: "susan.bourgeois@la.gov.demo",
    badge: "Executive",
    scenario: "Economic development oversight",
    group: "Louisiana Governor's Office of Major Projects & Delivery",
    displayTitle: "Louisiana Economic Development Secretary",
    organization: "Louisiana Economic Development (LED)",
    organizationalUnit: "Executive Office",
    workEmail: "susan.bourgeois@la.gov.demo",
  },
  {
    id: "jordan-thibodaux",
    name: "Jordan Thibodaux",
