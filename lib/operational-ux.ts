...
function rfiToWorkItem(rfi: RFIRecord, persona: OperationalPersona): OperationalWorkItem {
  ...
  return {
    ...
    removesFromQueue: forCustomer && responseSubmitted ? "Wait for the reviewing agency to accept the response or request clarification." : forCustomer ? "Submit the response and required documents." : "Accept the response, request clarification, or record the review decision.",
