...
export default async function DemoResourceRoute({ params, searchParams }: { params: Promise<{ permitCode: string }>; searchParams?: Promise<{ resource?: string }> }) {
