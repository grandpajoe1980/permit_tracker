...
export default async function ProjectRoute({ params }: { params: Promise<{ projectNumber: string }> }) {
  ...
  if (!project) return <main className="mx-auto max-w-4xl p-8"><h1 className="text-2xl font-bold">Project not found</h1><p className="mt-2 text-slate-600">This project is not available to the signed-in participant.</p></main>;
