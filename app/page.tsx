...
export default function Home() {
  ...
  function renderCustomerOverview() {
    ...
    return <CustomerHome projectName={PROJECT_DISPLAY_NAME} onSubmitRequest={() => openRequestCenter()}>
      <PermitCatalogPanel catalog={catalog} templates={repository.getWorkflowTemplates()} onStartRequest={(permitId) => { setSelectedCatalogPermitId(permitId); setRequestCenterMode("permit"); navigate("requests"); }} />
