...
| R4 — real-stage schedule | Verified | September 9 staircase follow-up supersedes compressed concurrent bars: each stage stays 36px high with 4px vertical separation and the project row expands. Missing dates use a labeled display-only demo projection: configured duration or 10 days, abutting the preceding finish. Zero stops scheduling that stage and all successors. Local and deployed Chrome/Firefox Scenario 4 and focused behavior tests pass; deployed application SHA `32ad43f3ab0d8bee059114f1971a96526f3a818f`. |
