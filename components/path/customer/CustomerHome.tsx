  ...
  return (
    <div data-path-customer-home="true" className="space-y-6">
      <section className="rounded-2xl bg-[#00284d] p-5 text-white shadow-md sm:p-8" aria-label="Start a request">
        ...
        <p className="mt-3 max-w-2xl text-base text-slate-200">Request a permit, government service, or help moving your project forward. Published permit workflows can route using your answers; other requests go to project office review. Track the next step here.</p>
